...
class Invoice(Base):
    ...
    previous_reading_date: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    current_reading_date: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    ...
    previous_arrears: Mapped[Optional[float]] = mapped_column(Float, nullable=True, default=0.0)
    created_at: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    updated_at: Mapped[Optional[str]] = mapped_column(String, nullable=True)
